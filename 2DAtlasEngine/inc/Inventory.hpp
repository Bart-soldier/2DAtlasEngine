...
namespace AE
{
	/// <summary>The <see cref="Inventory"/> is used to store <see cref="SceneObject"/>, as well as provide various elements for displaying the inventory bar.</summary>
	class Inventory
	{
	public:
		/// <summary>The <see cref="Inventory"/> is used to store <see cref="SceneObject"/>, as well as provide various elements for displaying the inventory bar.</summary>
		...
		/// <param name='capacity'>The amount of <see cref="SceneObject"/> the inventory can hold.</param>
		...
		/// <param name='item'>The <see cref="SceneObject"/> to add to the inventory.</param>
		...
		/// <returns>The amount of <see cref="SceneObject"/> the inventory can hold.</returns>
		int GetCapacity();
		...
		/// <returns>The <see cref="SceneObject"/> at that inventory position,
		/// <para>nullptr if not found or out of bounds.</para></returns>
		SceneObject* GetAt(int index);
		/// <summary> Gets the item at the <see cref="_currentIndex"/> position within the inventory.</summary>
		/// <returns>The <see cref="SceneObject"/> at said position,
		/// <para>nullptr if not found or out of bounds.</para></returns>
		SceneObject* GetAtCurrentIndex();
	...
	private:
		...
		/// <summary>The inventory constituted of <see cref="SceneObject"/>s.</summary>
		std::vector<SceneObject*> _items;
		/// <summary>The amount of <see cref="SceneObject"/> the inventory can hold.</summary>
		int _capacity;
